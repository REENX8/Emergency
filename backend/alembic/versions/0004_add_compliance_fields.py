...
down_revision: Union[str, None] = "0003_add_audit_log"
...
def upgrade() -> None:
    with op.batch_alter_table("buildings") as batch_op:
        batch_op.add_column(sa.Column("has_sprinkler", sa.Boolean, nullable=False, server_default=sa.text("0")))
        batch_op.add_column(sa.Column("building_type", sa.String,  nullable=False, server_default="office"))
        batch_op.add_column(sa.Column("total_floors",  sa.Integer, nullable=False, server_default="1"))
